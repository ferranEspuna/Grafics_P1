...
public:
    ...
    // S'obliga a implementar els següents mètodes en les classes filles: es un metode abstracte

    // Funcio que retorna la intersecció més propera al t_min del raig. La intersecció
    // estarà entre t_min i t_max
     virtual bool closestHit (Ray& r, HitInfo& info) = 0;

    // Funcio que detecta si el raig te alguna interseccio entre el t_min i el t_max del raig
    virtual bool hasHit(const Ray& raig) = 0;
