...
void InfoMapping::print(int indentation) const
{
    ...
    QTextStream(stdout) << indent.toInt()+2 << "minPoint:\t"  << Rxmin<<", "<< Rzmin<<"\n";
    QTextStream(stdout) << indent.toInt()+2 << "maxPoint:\t"  << Rxmax<<", "<< Rzmax<<"\n";

    QTextStream(stdout) << indent << "Virtual:\t \n";
    QTextStream(stdout) << indent.toInt()+2 << "minPoint:\t"  << Vxmin<<", "<< Vymin<<", "<< Vzmin<<"\n";
    QTextStream(stdout) << indent.toInt()+2 << "maxPoint:\t"  << Vxmax<<", "<< Vymax<<", "<< Vzmin<<"\n";
