...
shared_ptr<Light> LightFactory::createLight(vec3 posicio, vec3 Ia, vec3 Id, vec3 Is, float a, float b, float c, LIGHT_TYPES t) {
    ...
    case POINTLIGHT:
        ...
        break;
    case SPOTLIGHT:
        l = make_shared<SpotLight>(posicio, Ia, Id, Is, a, b, c);
        break;
    case AREALIGHT:
        l = make_shared<AreaLight>(posicio, Ia, Id, Is, a, b, c);
        break;
    default:
        break;
    }
...
LightFactory::LIGHT_TYPES LightFactory::getIndexType (shared_ptr<Light> l) {
    ...
    if (dynamic_pointer_cast<SpotLight>(l) != nullptr) {
        return LIGHT_TYPES::SPOTLIGHT;
    }
    if (dynamic_pointer_cast<AreaLight>(l) != nullptr) {
